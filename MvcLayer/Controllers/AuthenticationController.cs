...
namespace client_test.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public ActionResult LogIn(string returnUrl)
        {
            ...
            {
                [OpenIddictClientAspNetCoreConstants.Properties.Issuer] = "https://authsrv.rupbes.by:8011/"
            })
            {
        ...
        public async Task<ActionResult> LogInCallback()
        {
            ...
            .Where(claim => claim switch
            {
                ...
                { Type: ClaimTypes.NameIdentifier or ClaimTypes.Name or ClaimTypes.Email or Claims.Role } => true,
            ...
            //добавляем все Claims из таблицы AspNetUser(приходят с сервера в виде JSON объекта
            //////////////////////////////////////////////////////////////////////////////////
            foreach (var item in result?.Principal?.Claims?.Where(cl => cl.Type == "claims"))
            {
                var clm = new JavaScriptSerializer().Deserialize<Claim>(item.Value);
                claims.Add(clm);
            }
