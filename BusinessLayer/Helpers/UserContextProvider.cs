...
{
    internal class UserContextProvider : IHttpContextUserProvider
    {

        private readonly IHttpContextAccessor _httpCntxt;
        private readonly IOpenIdDictUoW _openIdDictCntxt;
        public UserContextProvider(IHttpContextAccessor contextAccessor, IOpenIdDictUoW openIdDictUoW)
        {
