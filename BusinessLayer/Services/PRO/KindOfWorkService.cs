...
namespace BusinessLayer.Services.PRO
{
    internal class KindOfWorkService : IKindOfWorkService
    {
        ...
        public KindOfWorkService(IContractUoW database, IMapper mapper, IContractsLogger logger, IHttpContextAccessor http)
        {
            _database = database;
            _mapper = mapper;
            _logger = logger;
        ...
        public IEnumerable<KindOfWorkDTO> Find(Func<KindOfWork, bool> predicate, bool? booluseArchiveData)
        {
