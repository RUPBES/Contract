...
namespace BusinessLayer.Services
{
    internal class MaterialCostService : IMaterialCostService
    {
        ...
        public MaterialCostService(IContractUoW database, IMapper mapper, IContractsLogger logger)
        {
            _database = database;
            _mapper = mapper;
            _logger = logger;
        ...
        public IEnumerable<MaterialCostDTO> Find(Func<MaterialCost, bool> predicate, bool? booluseArchiveData)
        {
