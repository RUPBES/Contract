...
public partial class ContractsArchiveContext : DbContext
{
    public ContractsArchiveContext()
    {
    }

    public ContractsArchiveContext(DbContextOptions<ContractsContext> options) : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        var connectionString = configuration.GetConnectionString("DataArchive");
